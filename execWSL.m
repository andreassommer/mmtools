...
%      #showWSLoutput --> Enable/disable displaying output generated by WSL command
%                         Example:  execWSL('#displayWSLoutput', false);  (default: true)
%
% Andreas Sommer, Jul2024
% code@andreas-sommer.eu
%

persistent WSLdistro verbose haltOnError dryrun silentmode showWSLoutput
...
if isempty(showWSLoutput), showWSLoutput = true ; end
